...
/*   Updated: 2024/05/21 17:20:20 by tamehri          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap( std::string name ) : __name(name), __HitPoints(10), __EnergyPoints(10), __AttackDamage(0) {
	std::cout << "\033[1;32mString constructor called\033[0m" << std::endl;
}
...
ClapTrap::~ClapTrap() {
	std::cout << "\033[1;32mDestructor called\033[0m" << std::endl;
